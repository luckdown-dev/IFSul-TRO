...
byte vHexa[6] = {B11101110, B00111110, B10011100, B01111010, B10011110, B10001110};
...
void loop(){
    exibeHexaDecimal(346);
    atualizaDisplayComDelay(250);

}

void exibeHexaDecimal(int numero){
  int digito;
